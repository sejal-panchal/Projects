...
namespace EpicUniversity.Migrations
{
    ...
    [Migration("20201218225540_ChangeSudentGradeToGpa")]
    partial class ChangeSudentGradeToGpa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EpicUniversity.Models.CourseLab", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("EpicUniversity.Models.CourseLab", b =>
                {
                    b.HasOne("EpicUniversity.Models.Course", "Course")
                        .WithOne("CourseLab")
                        .HasForeignKey("EpicUniversity.Models.CourseLab", "CourseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
